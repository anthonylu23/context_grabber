...
/**
 * Browser-agnostic extraction input. Identical shape for Chrome and Safari;
 * the only difference is which `browser` tag is stamped on the resulting
 * {@link BrowserContextPayload}.
 */
...
export const createCaptureResponseMessage = (
